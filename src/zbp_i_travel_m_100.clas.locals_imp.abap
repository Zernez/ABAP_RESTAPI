...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_100.
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_travel_m_100 FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
...
**********************************************************************
  METHOD validate_customer.
    ...
    READ ENTITY zi_travel_m_100\\travel FROM VALUE #(
...
********************************************************************************
    METHOD set_status_completed.
      ...
      MODIFY ENTITIES OF zi_travel_m_100 IN LOCAL MODE
             ENTITY travel
      ...
      READ ENTITIES OF zi_travel_m_100 IN LOCAL MODE
           ENTITY travel
    ...
    METHOD calculatetravelkey.
      ...
      "Get max travelID
      SELECT SINGLE FROM ztravel_100 FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).
