CLASS zcl_generate_travel_data_100 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_100 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_100.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_100.

*   insert the new table entries
    INSERT ztravel_100 FROM TABLE @itab.
